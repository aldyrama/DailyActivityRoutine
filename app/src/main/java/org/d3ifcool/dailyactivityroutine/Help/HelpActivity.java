...
public class HelpActivity extends AppCompatActivity {
    String item[] = new String[] {"Cara penggunaan", "Saran & Masukan"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener( new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                Toast.makeText( HelpActivity.this,item[position], Toast.LENGTH_SHORT).show();
                switch (position){
                    case 0:
                        Intent myinntent = new Intent( view.getContext(),TutorialActivity.class );
                        startActivity( myinntent );
                        break;
                    case 1 :
                        myinntent = new Intent( view.getContext(), Feedback.class );
                        startActivity( myinntent );
                        break;
                    }
                }
